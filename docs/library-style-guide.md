...
- Secondary Reference: Use the Library (capitalized) when referring to the GSU Library as a specific entity. Use library or libraries (lowercase) for general references, buildings, or as a descriptor (e.g., "library study rooms").
...
- Building Names: \* Atlanta: Library North, Library South.
  - Perimeter: CL Building, Learning Resource Center.
- Floors: \* Use numerals when combined with a building name: Library North 2.
...
- WordPress Components:
  - Use the Georgia State Toggle instead of standard accordions.
  - Use H4 headings within Toggles.
  - Use GSU Standard Blue Button for primary calls to action.
  - Use Separator with Text for titles over toggles or tables.
